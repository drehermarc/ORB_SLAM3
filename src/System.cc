...
void System::SaveTrajectoryEuRoC(const string &filename)
{
    ...
    // Rumlang1 Horizontal
/*     float init_pose[4][4] = {{-9.99999996e-01,  1.52757719e-06,  9.47505855e-05,  1.56192000e-01},
 {-9.47539695e-05, -2.39284849e-03, -9.99997133e-01, -5.49764000e-01},
 {-1.30084901e-06, -9.99997137e-01,  2.39284863e-03,  1.25587700e+00},
 { 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00}}; */

    // Basement 1 Horizontal Movement
/*     float init_pose[4][4] = {{-9.99999996e-01,  1.52438702e-06,  9.19220909e-05,  1.56193000e-01},
 {-9.19254809e-05, -2.39708943e-03, -9.99997123e-01, -5.49764000e-01},
 {-1.30403716e-06, -9.99997127e-01,  2.39708956e-03,  1.25588000e+00},
 {0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00}}; */
    
    // Wall 1
float init_pose[4][4] = {{-9.99999802e-01, 3.48346828e-06, -6.29329870e-04, -4.00000000e-02},
 {6.29319634e-04, -2.41264859e-03, -9.99996892e-01, -5.49764000e-01},
 {-5.00180928e-06, -9.99997090e-01,  2.41264592e-03,  1.25587800e+00},
 {0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00}};

    // Wall 2
/*     float init_pose[4][4] = {{-9.99999841e-01,  3.56633143e-06, -5.64275665e-04, -4.00000000e-02},
 {5.64265495e-04, -2.39709050e-03, -9.99996968e-01, -5.49764000e-01},
 {-4.91894045e-06, -9.99997127e-01,  2.39708811e-03,  1.25587800e+00},
 {0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00}}; */
    
    // Textured wall 1
/*     float init_pose[4][4] = {{-9.99999097e-01,  4.04944932e-06, -1.34350861e-03, -4.00000000e-02},
 {1.34349507e-03, -2.39285129e-03, -9.99996235e-01, -5.49763000e-01},
 {-7.26425037e-06, -9.99997137e-01,  2.39284369e-03,  1.25587800e+00},
 {0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00}};*/
    // Textured wall 2
/*     float init_pose[4][4] = {{-9.99999010e-01,  2.55710672e-06, -1.40714642e-03, -4.00000000e-02},
 {1.40713625e-03, -2.39567878e-03, -9.99996140e-01, -5.49764000e-01},
 {-5.92816766e-06, -9.99997130e-01,  2.39567281e-03,  1.25587900e+00},
 {0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00}}; */

    cv::Mat initial_pose = cv::Mat(4, 4, CV_32F, &init_pose);
        ...
        lend=mpTracker->mlRelativeFramePoses.end();lit!=lend;lit++, lRit++, lT++, lbL++)
    {
        ...
        else
        {
            ...
            Rwc = Rwc*initial_pose.rowRange(0, 3).colRange(0, 3);
            twc = initial_pose.rowRange(0, 3).col(3) + twc;
